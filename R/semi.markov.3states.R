...
semi.markov.3states <-function(times1, times2, sequences, weights=NULL, dist, cuts.12=NULL,cuts.13=NULL,cuts.23=NULL,ini.dist.12=NULL, ini.dist.13=NULL, ini.dist.23=NULL, cov.12=NULL, init.cov.12=NULL, names.12=NULL, cov.13=NULL, init.cov.13=NULL, names.13=NULL, cov.23=NULL, init.cov.23=NULL, names.23=NULL, conf.int=TRUE, silent=TRUE, precision=10^(-6))
{
...
if (min(times1,na.rm=T)<0)
		stop("Negative values for 'times1' are not aollowed")
if (is.na(min(times1)))
...
if (min(times2,na.rm=T)<0)
		stop("Negative values for 'times2' wil be removed from the analysis")
...
if (!all(is.na(times2[which(sequences==1 | sequences==13)])))		
		stop("Arguments 'times2' have to be NA for right-censored individuals in X=1 or individuals who directly transited from X=1 to X=3")
...
c123<-function(times1, times2, z12, z13, z23, cutimes12, cutimes13, cutimes23)
 {return(log.h12(times1, z12, cutimes12) - H12(times1, z12, cutimes12) - H13(times1, z13, cutimes13) + log.h23(times2, z23, cutimes23) - H23(times2, z23, cutimes23))}

c12<-function(times1, times2, z12, z13, z23, cutimes12, cutimes13, cutimes23)
 {return(log.h12(times1, z12, cutimes12) - H12(times1, z12, cutimes12) - H13(times1, z13, cutimes13) - H23(times2, z23, cutimes23))}
