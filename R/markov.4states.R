...
markov.4states <-function(times1, times2, sequences, weights=NULL, dist, cuts.12=NULL,cuts.13=NULL,cuts.14=NULL,cuts.23=NULL,cuts.24=NULL,ini.base.12=NULL, ini.base.13=NULL, ini.base.14=NULL, ini.base.23=NULL, ini.base.24=NULL, cov.12=NULL, init.cov.12=NULL, names.12=NULL, cov.13=NULL, init.cov.13=NULL, names.13=NULL, cov.14=NULL, init.cov.14=NULL, names.14=NULL, cov.23=NULL, init.cov.23=NULL, names.23=NULL, cov.24=NULL, init.cov.24=NULL, names.24=NULL, conf.int=TRUE, silent=TRUE, precision=10^(-6))
{
#check conditions
if (missing(times1)) 
...
if (!all(is.na(times2[which(sequences==1 | sequences==13 | sequences==14)])))		
		stop("Arguments 'times2' should be NA for right-censored individuals in X=1 or individuals who directly transited from X=1 to X=3 or to X=1 to X=4")
...
c1<-function(times1, z12, z13, z14, cutimes12, cutimes13, cutimes14)
 {return( -H12(times1, z12, cutimes12) - H13(times1, z13, cutimes13)- H14(times1, z14, cutimes14))}

c12<-function(times1, times2, z12, z13, z14, z23, z24, cutimes12, cutimes13, cutimes14, cutimes23, cutimes24)
 {return(log.h12(times1, z12, cutimes12) - H12(times1, z12, cutimes12) - H13(times1, z13, cutimes13) - H14(times1, z14, cutimes14) - H23(times1, times2, z23, cutimes23) - H24(times1, times2, z24, cutimes24))}

c13<-function(times1, z12, z13, z14, cutimes12, cutimes13, cutimes14)
 {return(log.h13(times1, z13, cutimes13) - H12(times1, z12, cutimes12) - H13(times1, z13, cutimes13) - H14(times1, z14, cutimes14))}

c14<-function(times1, z12, z13, z14, cutimes12, cutimes13, cutimes14)
 {return(log.h14(times1, z14, cutimes14) - H12(times1, z12, cutimes12) - H13(times1, z13, cutimes13) - H14(times1, z14, cutimes14))}

c123<-function(times1, times2, z12, z13, z14, z23, z24, cutimes12, cutimes13, cutimes14, cutimes23, cutimes24)
 {return(log.h12(times1, z12, cutimes12) - H12(times1, z12, cutimes12) - H13(times1, z13, cutimes13) - H14(times1, z14, cutimes14) + log.h23(times2, z23, cutimes23) - H23(times1, times2, z23, cutimes23) - H24(times1, times2, z24, cutimes24))}

c124<-function(times1, times2, z12, z13, z14, z23, z24, cutimes12, cutimes13, cutimes14, cutimes23, cutimes24)
 {return(log.h12(times1, z12, cutimes12) - H12(times1, z12, cutimes12) - H13(times1, z13, cutimes13) - H14(times1, z14, cutimes14) + log.h24(times2, z24, cutimes24) - H23(times1, times2, z23, cutimes23) - H24(times1, times2, z24, cutimes24))}
...
.c13.14 <- cov.14.mat[(sequences==13 & .na),]
...
warning("Number of data rows:",nrow(.D))
