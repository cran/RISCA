...
roc.prognostic.individual<-function(times, failures, variable, iterations=0)
{
...
.auc.b <- rep(-99, iterations)
.lower.b <- rep(-99, iterations)
.pessimist.b <- rep(-99, iterations)
.upper.b <- rep(-99, iterations)
.non.informative.b <- rep(-99, iterations)
.optimist.b <- rep(-99, iterations)
